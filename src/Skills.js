        ...
        <Container>
            <Row>
                ...
                <div className="skill-fix" >
                    <h2 className=' align-item-center text-center'>My  Technical Skills</h2>
                    <p className='align-item-center'>A brief summary of my primary technical skill set and tools is provided below.</p>
